/* ****************************************************************************
* MVCControlToolkit.Controls-2.4.5.js
...
if (typeof $ !== 'undefined' && $ !== null && typeof $.validator !== 'undefined' && $.validator !== null && typeof $.validator.unobtrusive !== 'undefined' && $.validator.unobtrusive !== null) {
    ...
    (function ($) {
        ...
        $.validator.takeDynamicValue = function (fieldToVerify, fieldName) {
            ...
            if ($(element).attr('data-element-type') == 'native') return MvcControlsToolkit_native_GetString(element, true);
    ...
    $.validator.addMethod(
        ...
        function (value, element, param) {
            ...
            if ($(element).attr('data-element-type') == 'native') value = MvcControlsToolkit_native_GetString(element, true);
    ...
    $(document).ready(function () {
        ...
        $("." + pagerId + "_class").click(function () {
            ...
            if (clientModel != '' && pageSizeName != '') {
                ...
                data.itemsPerPage = MvcControlsToolkit_TypedTextBox_GetById(pageSizeId, MvcControlsToolkit_DataType_Int);
...
function MvcControlsToolkit_DisplayEdit_Init(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15) {
    $(document).ready(function () {
        var tTb = $('#' + p0);
        if (p13 != null) tTb.datepicker(p13);
...
(function () {
    ...
    function DateInput_Initialize(id) {
        ...
        if ($('#' + id + '_Hidden').data('_DateInCalendar')) {
            var options = $('#' + id + '_Calendar').data('_CalendarOptions');
    ...
    function DateInputChanged(evt, cid, update, force, init) {
        ...
        if ($('#' + clientID + '_Hidden').data('Recursive') == true && force == null) return;
        $('#' + clientID + '_Hidden').data('Recursive', true)
        ...
        var NMinutes;
        var NSeconds;
        var CurrDate = $('#' + clientID + '_Hidden').data('_Curr');
        ...
        var currMin = $('#' + clientID + '_Hidden').data('_MinDate') || null;
        var currMax = $('#' + clientID + '_Hidden').data('_MaxDate') || null;

        var dynamicMin = $('#' + clientID + '_Hidden').data('_ClientDynamicMin') || null;
        if (dynamicMin) dynamicMin = dynamicMin();
        var dynamicMax = $('#' + clientID + '_Hidden').data('_ClientDynamicMax') || null;
        ...
        var MinSeconds;
        var MaxSeconds;
        $('#' + clientID + '_Hidden').data('_Valid', true);
        ...
        if (!isNaN(NewYear)) {
            ...
            if (document.getElementById(clientID + "_Year") != null && !$('#' + clientID + '_Hidden').data('_DateHidden') && !$('#' + clientID + '_Hidden').data('_DateInCalendar'))
            ...
            if ((MaxYear == null || MaxYear >= NewYear) && (MinYear == null || MinYear <= NewYear)) {
                ...
                if (!isNaN(NewMonth)) {
                    ...
                    if (init || CurrYear == MinYear || CurrYear == MaxYear || NewYear == MinYear || NewYear == MaxYear)
                        if (document.getElementById(clientID + "_Month") != null && !$('#' + clientID + '_Hidden').data('_DateHidden') && !$('#' + clientID + '_Hidden').data('_DateInCalendar'))
                    ...
                    if (!isNaN(NewDay)) {
                        ...
                        if (document.getElementById(clientID + "_Day") != null && !$('#' + clientID + '_Hidden').data('_DateHidden') && !$('#' + clientID + '_Hidden').data('_DateInCalendar'))
                        ...
                        if (!isNaN(NewHours)) {
                            ...
                            if (!isNaN(NewMinutes)) {
                                ...
                                if (!isNaN(NewSeconds)) {
                                    ...
                                    $('#' + clientID + '_Hidden').data('_Valid', false);
                                }
                            }
        ...
        if ($('#' + clientID + '_Hidden').data('_DateInCalendar')) {
        ...
        var AChange = false;
        if ($('#' + clientID + '_Hidden').data('_Valid')) {
        ...
        if (!AChange) {
            $('#' + clientID + '_Hidden').data('Recursive', false);
            return true;
        }

        $('#' + clientID + '_Hidden').data('_Curr', new Date(CurrYear, CurrMonth, CurrDay, CurrHours, CurrMinutes, CurrSeconds));
        if (document.getElementById(clientID + "_Year") != null) {
        ...
        $('#' + clientID + '_Hidden').data('_ClientDateChanged')(currDate.getTime());
    ...
    function SetDateInput(id, value, cType) {
        if (!$('#' + id + '_Hidden').data('_Curr')) return;
        var currDate = $('#' + id + '_Hidden').data('_Curr');
        ...
        var currMin = $('#' + id + '_Hidden').data('_MinDate');
        var currMax = $('#' + id + '_Hidden').data('_MaxDate')
    ...
    function GetDateInput(id) {
     ...
     window['MvcControlsToolkit_DateTimeInput_SetString']=function(sorg, value) {
        clientID = sorg.id.substring(0, sorg.id.lastIndexOf("_"));
        var ob = null;
        if (value == null || value == "") {
            ob = new Date();
    ...
    window['MvcControlsToolkit_DateTimeInput_Set'] = function(sorg, value, format, valueType) {
        clientID = sorg.id.substring(0, sorg.id.lastIndexOf("_"));
    ...
    window['MvcControlsToolkit_DateTimeInput_SetById'] = function(id, value, format, valueType) {
        if (value == null || value == "") value = new Date();
        SetDateInput(id + '__', value.getTime(), 3);
    }
    window['MvcControlsToolkit_DateTimeInput_Get'] = function(sorg, valueType) {
        clientID = sorg.id.substring(0, sorg.id.lastIndexOf("_"));
    ...
    window['MvcControlsToolkit_DateTimeInput_GetById'] = function(id, valueType) {
        return $('#' + id + '___Hidden').data('_Curr');
    }
    window['MvcControlsToolkit_DateTimeInput_BindChange'] = function(id, handler) {
        $("#" + id + "___Hidden").bind("DateTimeInput_Changed", handler);
    }
    window['MvcControlsToolkit_DateTimeInput_UnbindChange'] = function(id, handler) {
        $("#" + id + "___Hidden").unbind("DateTimeInput_Changed", handler);
    }
    window['MvcControlsToolkit_DateTimeInput_GetString'] = function(sorg) {
        clientID = sorg.id.substring(0, sorg.id.lastIndexOf("_"));
    ...
    mvcct.basicControls.dateInputInitialize = DateInput_Initialize;
...
function DataGrid_ChecKInsertNewItem(itemRoot) {
    ...
    if (lastIndex == index) {
        ...
        var changeData = new MvcControlsToolkit_changeData($('#' + newDisplayItemName), 'NewHtmlCreated', 0);
...
function DataButton_Click(itemRoot, itemChanged, dataButtonType) {
    if (dataButtonType == DataButtonDelete) {
        ...
        changeData = new MvcControlsToolkit_changeData(newItem, 'ItemUndone', 0);
        jParent.trigger('itemChange', changeData);
    }
